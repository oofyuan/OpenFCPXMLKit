//
//  FCPXMLTimeAndFrameRateParsing.swift
...
extension OFKXMLElement {
    ...
    func _fcpNearestDuration<S: Sequence<any OFKXMLElement>>(
    ...
    /// - Parameters:
    ///   - ancestors: Optional replacement for ancestors. Ordered nearest to furthest ancestor.
    func _fcpNearestStart<S: Sequence<any OFKXMLElement>>(
        ancestors: S? = nil as [any OFKXMLElement]?,
        includingSelf: Bool
    ) -> Fraction? {
        let elements = ancestorElements(overrideWith: ancestors, includingSelf: includingSelf)
    ...
    /// - Parameters:
    ///   - ancestors: Optional replacement for ancestors. Ordered nearest to furthest ancestor.
    func _fcpNearestTCStart<S: Sequence<any OFKXMLElement>>(
        ancestors: S? = nil as [any OFKXMLElement]?,
        includingSelf: Bool
    ) -> Fraction? {
        let elements = ancestorElements(overrideWith: ancestors, includingSelf: includingSelf)
...
extension OFKXMLElement {
    ...
    func _fcpCalculateAbsoluteStart<S: Sequence<any OFKXMLElement>>(
        ancestors: S? = nil as [any OFKXMLElement]?,
    ...
    func _fcpConformRateScalingFactor<S: Sequence<any OFKXMLElement>>(
        ancestors: S? = nil as [any OFKXMLElement]?,
    ...
    func _fcpFirstAncestorWithZeroLane<S: Sequence<any OFKXMLElement>>(
        ancestors: S? = nil as [any OFKXMLElement]?,
        includingSelf: Bool
    ) -> (element: any OFKXMLElement, remainingAncestors: AnySequence<any OFKXMLElement>)? {
    ...
    ///
    /// Ancestors are ordered nearest to furthest.
    func _fcpFirstContainerAncestorWithZeroLane<S: Sequence<any OFKXMLElement>>(
        ancestors: S? = nil as [any OFKXMLElement]?,
        includingSelf: Bool
    ) -> (element: any OFKXMLElement, remainingAncestors: AnySequence<any OFKXMLElement>)? {
        var ancestors = ancestorElements(overrideWith: ancestors, includingSelf: includingSelf)
